...
import { adjustRestTimer, resumeRestTimer, type RestTimerState } from '../model/workoutSession'
...
export function useWorkoutSessionController(repository: WorkoutSessionRepository) {
