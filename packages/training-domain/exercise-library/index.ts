...
export const BUNDLED_EXERCISES: readonly BundledExercise[] = Object.freeze([
  ...
  bundled(['puxada_frente_maquina', 'Puxada à frente na máquina', ['puxador frente', 'puxada alta', 'lat pulldown', 'pulldown'], 'Costas', ['Bíceps'], 'Máquina de cabos', 'HYPERTROPHY', 'Iniciante', 'Puxada vertical guiada em direção ao tronco.', 'Prenda as coxas, mantenha o peito aberto e puxe a barra até a parte alta do peito.', false, false, 'EQUIPMENT']),
  ...
  bundled(['rosca_direta_barra', 'Rosca direta com barra', ['rosca direta', 'rosca barra', 'barbell curl', 'biceps curl'], 'Bíceps', ['Antebraços'], 'Barra', 'HYPERTROPHY', 'Iniciante', 'Flexão dos cotovelos em pé com barra.', 'Mantenha os cotovelos próximos ao tronco, eleve a barra e desça sem embalo.', false, false, 'EQUIPMENT']),
