...
describe('Home semanal', () => {
  ...
  it('mostra treino pronto, referência anterior, progresso, atalhos, badge e refresh', async () => {
    ...
    expect(content).toContain('Ver ficha ativa')
    expect(content).not.toContain('Fichas arquivadas')
    expect(content).not.toContain('Biblioteca')
    ...
    press(view, 'Ver ficha ativa')
    expect(props.onOpenPlans).toHaveBeenCalledOnce()
